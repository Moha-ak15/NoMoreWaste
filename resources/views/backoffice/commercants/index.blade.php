        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('commercants.show', $commercant->commercant_id) }}" class="btn btn-info btn-sm m-1">Voir</a>
                        <a href="{{ route('commercants.edit', $commercant->commercant_id) }}" class="btn btn-warning btn-sm">Éditer</a>
                        <form action="{{ route('commercants.destroy', $commercant->commercant_id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm m-1" onclick="return confirm('Voulez-vous vraiment supprimer ce commerçant ?');">Supprimer</button>
                        </form>
                    </td>
                </tr>
                @endforeach
